...
return [
    ...
    */
    ...
    'form-components' => [
        'form' => [
            'view' => 'blade-forms::components.vendor.form-components.form',
        ],
        'form-checkbox' => [
            'view' => 'blade-forms::components.vendor.form-components.form-checkbox',
        ],
        'form-errors' => [
            'view' => 'blade-forms::components.vendor.form-components.form-errors',
        ],
        'form-group' => [
            'view' => 'blade-forms::components.vendor.form-components.form-group',
        ],
        'form-input' => [
            'view' => 'blade-forms::components.vendor.form-components.form-input',
        ],
        'form-label' => [
            'view' => 'blade-forms::components.vendor.form-components.form-label',
        ],
        'form-radio' => [
            'view' => 'blade-forms::components.vendor.form-components.form-radio',
        ],
        'form-select' => [
            'view' => 'blade-forms::components.vendor.form-components.form-select',
        ],
        'form-submit' => [
            'view' => 'blade-forms::components.vendor.form-components.form-submit',
        ],
        'form-textarea' => [
            'view' => 'blade-forms::components.vendor.form-components.form-textarea',
        ],
    ],
];
